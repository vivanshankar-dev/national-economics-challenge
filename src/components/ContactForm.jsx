...
const ContactForm = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-primary/10 border border-primary/20 rounded-2xl p-6 flex items-start space-x-4">
        <div className="p-3 bg-primary rounded-full text-primary-foreground">
          <Mail className="w-5 h-5" />
        </div>
        <div>
          <h3 className="font-semibold text-foreground mb-1">Direct Email Contact</h3>
          <p className="text-sm text-muted-foreground">
            You can also reach us directly at{' '}
            <a 
              href="mailto:vivan.shankar@gmail.com" 
